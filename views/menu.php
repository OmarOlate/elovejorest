...
<head>
  ...
  <!-- Site Icons -->
  <link rel="apple-touch-icon" href="images/svg/LogoOvejoPng.svg" />
...
<body>
  ...
  <!-- en -->
  <img src="images/imagenes-ovejo/LogoOvejoPng.png" alt="" class="logo_flotante">
  <div id="banner " class=" carta-menu">
    ...
    <!-- <div class="tittle-categoria block-title text-center">Entradas</div> -->
    <!-- <div class="content-productos" id="product-modal"> -->
    <!-- <div class="product-top row"> -->
    <!-- <div class="name-product"><?php echo $view["nombre_producto"]; ?><i class="fas fa-images icons-1" id="icons-enabled" alt="no dispobible"> </i></div> -->
    <!-- <div class="price-product">$2.990</div> -->
    <!-- </div> -->
    <!-- <div class="product-botton"> -->
    <!-- <p>Texto de prueba para descripcion en productos</p> -->
    <!-- </div> -->
    <!-- </div> -->
    ...
    <div class="categoria-menu">
      ...
      <div class="content-productos" id="product-modal">
        <div class="product-top row">
          <div class="name-product">Osobuco con rissoto parmesano<i class="fas fa-images icons-1" id="icons-enabled" alt="no dispobible"> </i></div>
          <div class="price-product">$14.900</div>
        </div>
        <div class="product-botton">
          <p>Guido de 450g. de osobuco de ternera cocido lentamente por algnas horas para cortar con la cuchara, acompañada dcon un rissoto a la parmesana con champiñones.</p>
        </div>
      </div>
      <div class="content-productos" id="product-modal">
        <div class="product-top row">
          <div class="name-product">Lomo saltado <i class="fas fa-images icons-1" id="icons-enabled" alt="no dispobible"> </i></div>
          <div class="price-product">$13.300</div>
        </div>
        <div class="product-botton">
          <p>Al más puo estilo de un lomo saltado bien peruano. Filete de vacuno salteado con verduras frescas, cebolla, tomates, guisada con su salsa de lomo y acompañada con arroz y papas fritas.</p>
        </div>
      </div>
      <div class="content-productos" id="product-modal">
        <div class="product-top row">
          <div class="name-product">Dia 29 de ñoquis <i class="fas fa-images fa-sad-tear icons-2" id="icons-disabled" alt="no dispobible"> </i></div>
      ...
      <div class="content-productos" id="product-modal">
        <div class="product-top row">
          <div class="name-product">Tallarin saltado <i class="fas fa-images icons-1" id="icons-enabled" alt="no dispobible"> </i></div>
